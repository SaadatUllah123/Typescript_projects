  ...
  while (true) {
    ...
    if (userChoice.choice === "Attack") {
      ...
      if (num > 0) {
        ...
        console.log(
          chalk.greenBright(`${opponent.name} fuel is ${opponent.fuel}`)
        );
      ...
      if (num <= 0) {
        ...
        console.log(
          chalk.redBright(`${opponent.name} fuel is ${opponent.fuel}`)
        );
        if (opponent.fuel <= 0) {
      ...
      if (num > 0) {
        if (player.fuel < 100) {
          player.fuelIncrease();
          console.log(
            chalk.greenBright(`${player.name} fuel has been increased is 25.`)
          );
        } else if ((player.fuel = 100)) {
          console.log(
            chalk.greenBright(`${player.name} fuel cannot exceed 100.`)
          );
        }
      }
      ...
      if (num <= 0) {
        if (opponent.fuel < 100) {
          ...
          console.log(
            chalk.greenBright(`${opponent.name} fuel has been increased is 25.`)
          );
        } else if ((opponent.fuel = 100)) {
          console.log(
            chalk.greenBright(`${opponent.name} fuel cannot exceed 100.`)
          );
        }
      }
    }
