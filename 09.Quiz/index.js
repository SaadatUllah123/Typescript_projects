...
let userAnswers = await inquirer.prompt([
    ...
    },
    {
        name: "thirdAns",
        type: "list",
        message: "Which of the following TypeScript types allows multiple types for a variable?",
...
function ShowResult() {
    console.clear();
    console.log(`\n1.Question: ${chalk.greenBright(firstQueu)}\n2.Question: ${chalk.greenBright(secondQueu)}\n3.Question: ${chalk.greenBright(thirdQueu)}\n4.Question: ${chalk.greenBright(forthQueu)}\n5.Question: ${chalk.greenBright(fiveQueu)}`);
    console.log(chalk.cyanBright(`\nContragulation!`));
    console.log(chalk.greenBright(`Your correct answer are: ${chalk.white(correctAns)}\nYour incorrect answer are: ${chalk.white(incorrectAns)}`));
}
ShowResult();
